                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('Fees.store') }}" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputState"> {{ __('Fees_trans.Grade') }}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputZip"> {{ __('Fees_trans.Class') }} </label>
                                <select class="custom-select mr-sm-2" name="Classroom_id">

                                </select>
                            </div>
                            <div class="form-group col">
                                <label for="inputZip">  {{ __('Fees_trans.Year') }}</label>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Fee_type">
                                    ...
                                    <option value="3">{{ __('Fees_trans.Book_Fee') }} </option>
                        ...
                        <button type="submit" class="btn btn-primary">{{ __('Fees_trans.submit') }}</button>
